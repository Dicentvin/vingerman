...
import {
  LayoutDashboard, Mic2, Languages, Volume2, Mic, BookOpen, LogOut, Flame, Menu, X,
} from 'lucide-react'
    ...
    <>
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/[0.07] flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden text-gray-500 hover:text-gray-200 p-1"
        >
          <X size={20} />
        </button>
      </div>
    ...
    <div className="flex min-h-screen">
      ...
      <aside
        className={`
          ...
          w-60 bg-ink-900 border-r border-white/[0.07] flex flex-col shrink-0
