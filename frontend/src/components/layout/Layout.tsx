...
const navItems = [
  ...
  { to: '/materials',     icon: Folder,          label: 'My Materials'        },
    ...
    <div className="flex min-h-screen">
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <aside className="relative w-72 max-w-[80vw] bg-ink-900 flex flex-col z-50 shadow-2xl">
            <SidebarContent/>
          </aside>
        </div>
      )}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3 bg-ink-900 border-b border-white/[0.07] sticky top-0 z-30">
          ...
          <span className="font-display text-lg text-gold">German Made Easy</span>
